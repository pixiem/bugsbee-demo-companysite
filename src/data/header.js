...
const headerData = {
  title: "Bugs Bee - DIgital Agency NextJS Template",
  ...
  email: "bugsbeeit@gmil.com",
  icon,
  socials,
  text: "Bugs Bee is a premium Template for Digital Agencies, Start Ups, Small Business and a wide range of other agencies.",
};
